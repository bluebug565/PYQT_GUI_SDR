...
# Form implementation generated from reading ui file 'sdr_settings.ui'
#
...
class Ui_QSpectrumAnalyzerSettings(object):
    ...
    def retranslateUi(self, QSpectrumAnalyzerSettings):
        ...
        QSpectrumAnalyzerSettings.setWindowTitle(_translate("QSpectrumAnalyzerSettings", "Settings - SDRAnalyzer"))
...
if __name__ == "__main__":
    ...
    QSpectrumAnalyzerSettings = QtWidgets.QDialog()
    ui = Ui_QSpectrumAnalyzerSettings()
    ui.setupUi(QSpectrumAnalyzerSettings)
    QSpectrumAnalyzerSettings.show()
    sys.exit(app.exec_())
