...
# Form implementation generated from reading ui file 'sdr_smoothing.ui'
#
...
class Ui_QSpectrumAnalyzerSmoothing(object):
    def setupUi(self, QSpectrumAnalyzerSmoothing):
        ...
        QSpectrumAnalyzerSmoothing.resize(257, 122)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/CU-Logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        QSpectrumAnalyzerSmoothing.setWindowIcon(icon)
    ...
    def retranslateUi(self, QSpectrumAnalyzerSmoothing):
        ...
        QSpectrumAnalyzerSmoothing.setWindowTitle(_translate("QSpectrumAnalyzerSmoothing", "Smoothing - SDRAnalyzer"))
...
if __name__ == "__main__":
    ...
    QSpectrumAnalyzerSmoothing = QtWidgets.QDialog()
    ui = Ui_QSpectrumAnalyzerSmoothing()
    ui.setupUi(QSpectrumAnalyzerSmoothing)
    QSpectrumAnalyzerSmoothing.show()
    sys.exit(app.exec_())
