...
# Form implementation generated from reading ui file 'sdr_colors.ui'
#
...
class Ui_QSpectrumAnalyzerColors(object):
    ...
    def retranslateUi(self, QSpectrumAnalyzerColors):
        ...
        QSpectrumAnalyzerColors.setWindowTitle(_translate("QSpectrumAnalyzerColors", "Colors - SDRAnalyzer"))
...
if __name__ == "__main__":
    ...
    QSpectrumAnalyzerColors = QtWidgets.QDialog()
    ui = Ui_QSpectrumAnalyzerColors()
    ui.setupUi(QSpectrumAnalyzerColors)
    QSpectrumAnalyzerColors.show()
    sys.exit(app.exec_())
