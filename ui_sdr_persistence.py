...
# Form implementation generated from reading ui file 'sdr_persistence.ui'
#
...
class Ui_QSpectrumAnalyzerPersistence(object):
    def setupUi(self, QSpectrumAnalyzerPersistence):
        ...
        QSpectrumAnalyzerPersistence.setWindowIcon(icon)
    ...
    def retranslateUi(self, QSpectrumAnalyzerPersistence):
        ...
        QSpectrumAnalyzerPersistence.setWindowTitle(_translate("QSpectrumAnalyzerPersistence", "Persistence -SDRAnalyzer"))
...
if __name__ == "__main__":
    ...
    QSpectrumAnalyzerPersistence = QtWidgets.QDialog()
    ui = Ui_QSpectrumAnalyzerPersistence()
    ui.setupUi(QSpectrumAnalyzerPersistence)
    QSpectrumAnalyzerPersistence.show()
    sys.exit(app.exec_())
